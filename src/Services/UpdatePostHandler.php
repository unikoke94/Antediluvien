...
class UpdatePostHandler 
{
	...
	public function __construct(EntityManagerInterface $em, FormFactoryInterface $formFactory, FlusherService $flusher, ContainerInterface $container, AuthorizationCheckerInterface $checker)
	{
		$this->em = $em;
